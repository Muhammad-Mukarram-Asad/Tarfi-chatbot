...
export function ComparisonBarChart({
  ...
  // --- Calculate global Y max for all datasets ---
      ...
      >
          ...
          <ResponsiveContainer width="100%" height="100%" style={{ pointerEvents: "none" }}>
            ...
            >
              ...
              <YAxis
                ...
                width={yAxisWidth}
              />
              {/* Invisible bars to maintain Y scale */}
        ...
        <div
          style={{
            ...
            overflowY: "hidden",
            height: "100%",
            marginLeft: "-1px", // overlap to hide line gap
          }}
        >
          <div style={{ width: `${chartWidth}px`, height: "100%" }}>
            <ResponsiveContainer width="100%" height="100%" style={{ pointerEvents: "none" }}>
                ...
                <tr key={rowIndex} className="border-b border-black">
                  {outerRow.map((col, colIndex) => (
                    <td
                      key={colIndex}
                      className={`px-4 py-2 text-center ${
                        colIndex === 0 ? "sticky left-0 z-20 bg-white border-black" : ""
                      }`}
                      style={{ fontSize: "14px" }}
                    >
                      {col}
